    ...
    public var backgroundColor: UIColor? {
        ...
        set{
            if navigationView == nil {
                ...
                navigationView = UIView(frame: CGRect.init(x: 0, y: -UIApplication.shared.statusBarFrame.height, width: navigationBar.bounds.width, height: navigationBar.bounds.height+UIApplication.shared.statusBarFrame.height))
    ...
    public var statusBarColor: UIColor? {
        ...
        set {
            if statusBarView == nil {
                statusBarView = UIView(frame: CGRect.init(x: 0, y: -UIApplication.shared.statusBarFrame.height, width: navigationBar.bounds.width, height: UIApplication.shared.statusBarFrame.height))
                ...
                if let navigationView = navigationView {
                    navigationBar.insertSubview(statusBarView!, belowSubview: navigationView)
                }else{
